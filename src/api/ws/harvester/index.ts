...
export type chia_harvester_commands = get_plots_command | get_connections_command;
export type TChiaHarvesterBroadcast = TGetPlotsBroadCast | TGetConnectionsBroadCast;
