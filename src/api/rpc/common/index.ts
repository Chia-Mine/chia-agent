...
export async function get_network_info<T extends TRPCAgent | TDaemon>(
  agent: T,
) {
...
export type WsGetConnectionsMessage = GetMessageType<
  chia_common_service,
  get_connections_command,
  TGetConnectionsResponse
>;
export async function get_connections<T extends TRPCAgent | TDaemon>(
  agent: T,
  params: TGetConnectionsRequest,
) {
...
export type WsOpenConnectionMessage = GetMessageType<
  chia_common_service,
  open_connection_command,
  TOpenConnectionResponse
>;
export async function open_connection<T extends TRPCAgent | TDaemon>(
  agent: T,
  params: TOpenConnectionRequest,
) {
...
>;
export async function close_connection<T extends TRPCAgent | TDaemon>(
  agent: T,
  params: TCloseConnectionRequest,
) {
...
export type WsStopNodeMessage = GetMessageType<
  chia_common_service,
  stop_node_command,
  TStopNodeResponse
>;
...
export type WsGetLogLevelMessage = GetMessageType<
  chia_common_service,
  get_log_level_command,
...
export type WsSetLogLevelMessage = GetMessageType<
  chia_common_service,
  set_log_level_command,
  TSetLogLevelResponse
>;
export async function set_log_level<T extends TRPCAgent | TDaemon>(
  agent: T,
  params: TSetLogLevelRequest,
) {
...
export type WsResetLogLevelMessage = GetMessageType<
  chia_common_service,
  reset_log_level_command,
