...
export type WsGetSignagePointMessage = GetMessageType<
  chia_farmer_service,
  get_signage_point_command,
  TGetSignagePointResponse
>;
export async function get_signage_point<T extends TRPCAgent | TDaemon>(
  agent: T,
  params: TGetSignagePointRequest,
) {
...
export type WsGetSignagePointsMessage = GetMessageType<
  chia_farmer_service,
  get_signage_points_command,
  TGetSignagePointsResponse
>;
export async function get_signage_points<T extends TRPCAgent | TDaemon>(
  agent: T,
) {
...
export type WsGetRewardTargetsMessage = GetMessageType<
  chia_farmer_service,
  get_reward_targets_command,
  TGetRewardTargetResponse
>;
export async function get_reward_targets<T extends TRPCAgent | TDaemon>(
  agent: T,
  params: TGetRewardTargetRequest,
) {
...
export type WsSetRewardTargetsMessage = GetMessageType<
  chia_farmer_service,
  set_reward_targets_command,
  TSetRewardTargetResponse
>;
export async function set_reward_targets<T extends TRPCAgent | TDaemon>(
  agent: T,
  params: TSetRewardTargetRequest,
) {
...
export type WsGetPoolStateMessage = GetMessageType<
  chia_farmer_service,
  get_pool_state_command,
...
export type set_payout_instructions_command =
  typeof set_payout_instructions_command;
export type TSetPayoutInstructionsRequest = {
  launcher_id: str;
  payout_instructions: str;
};
export type TSetPayoutInstructionsResponse = Record<string, never>;
export type WsSetPayoutInstructionsMessage = GetMessageType<
  chia_farmer_service,
  set_payout_instructions_command,
  TSetPayoutInstructionsResponse
>;
export async function set_pool_payout_instructions<
  T extends TRPCAgent | TDaemon,
>(agent: T, params: TSetPayoutInstructionsRequest) {
  type R = ResType<
    T,
    TSetPayoutInstructionsResponse,
...
export type WsGetHarvestersMessage = GetMessageType<
  chia_farmer_service,
  get_harvesters_command,
...
export type get_harvesters_summary_command =
  typeof get_harvesters_summary_command;
export type TGetHarvestersSummaryResponse = {
  harvesters: Array<Receiver<true>>;
};
export type WsGetHarvestersSummaryMessage = GetMessageType<
  chia_farmer_service,
  get_harvesters_summary_command,
  TGetHarvestersSummaryResponse
>;
export async function get_harvesters_summary<T extends TRPCAgent | TDaemon>(
  agent: T,
) {
  type R = ResType<
    T,
...
export type get_harvester_plots_valid_command =
  typeof get_harvester_plots_valid_command;
...
export type WsGetHarvesterPlotsValidMessage = GetMessageType<
  chia_farmer_service,
  get_harvester_plots_valid_command,
  TGetHarvesterPlotsValidResponse
>;
export async function get_harvester_plots_valid<T extends TRPCAgent | TDaemon>(
  agent: T,
  param: TGetHarvesterPlotsValidRequest,
) {
  type R = ResType<
    T,
    TGetHarvesterPlotsValidResponse,
...
export const get_harvester_plots_invalid_command =
  "get_harvester_plots_invalid";
export type get_harvester_plots_invalid_command =
  typeof get_harvester_plots_invalid_command;
...
export type WsGetHarvesterPlotsInvalidMessage = GetMessageType<
  chia_farmer_service,
  get_harvester_plots_invalid_command,
  TGetHarvesterPlotsInvalidResponse
>;
export async function get_harvester_plots_invalid<
  T extends TRPCAgent | TDaemon,
>(agent: T, param: TGetHarvesterPlotsInvalidRequest) {
  type R = ResType<
    T,
    TGetHarvesterPlotsInvalidResponse,
...
export const get_harvester_plots_keys_missing_command =
  "get_harvester_plots_keys_missing";
export type get_harvester_plots_keys_missing_command =
  typeof get_harvester_plots_keys_missing_command;
...
export type WsGetHarvesterPlotsKeysMissingMessage = GetMessageType<
  chia_farmer_service,
  get_harvester_plots_keys_missing_command,
  TGetHarvesterPlotsKeysMissingResponse
>;
export async function get_harvester_plots_keys_missing<
  T extends TRPCAgent | TDaemon,
>(agent: T, param: TGetHarvesterPlotsKeysMissingRequest) {
  type R = ResType<
    T,
    TGetHarvesterPlotsKeysMissingResponse,
...
export const get_harvester_plots_duplicates_command =
  "get_harvester_plots_duplicates";
export type get_harvester_plots_duplicates_command =
  typeof get_harvester_plots_duplicates_command;
...
export type WsGetHarvesterPlotsDuplicatesMessage = GetMessageType<
  chia_farmer_service,
  get_harvester_plots_duplicates_command,
  TGetHarvesterPlotsDuplicatesResponse
>;
export async function get_harvester_plots_duplicates<
  T extends TRPCAgent | TDaemon,
>(agent: T, param: TGetHarvesterPlotsDuplicatesRequest) {
  type R = ResType<
    T,
    TGetHarvesterPlotsDuplicatesResponse,
...
export type WsGetPoolLinkMessage = GetMessageType<
  chia_farmer_service,
  get_pool_login_link_command,
  TGetPoolLinkResponse
>;
export async function get_pool_login_link<T extends TRPCAgent | TDaemon>(
  agent: T,
  params: TGetPoolLinkRequest,
) {
