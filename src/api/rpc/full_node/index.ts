...
>;
export async function get_blockchain_state<T extends TRPCAgent | TDaemon>(
  agent: T,
) {
...
export type WsGetBlockMessage = GetMessageType<
  chia_full_node_service,
  get_block_command,
  TGetBlockResponse
>;
export async function get_block<T extends TRPCAgent | TDaemon>(
  agent: T,
  data: TGetBlockRequest,
) {
...
export type WsGetBlocksMessage = GetMessageType<
  chia_full_node_service,
  get_blocks_command,
  TGetBlocksResponse
>;
export async function get_blocks<T extends TRPCAgent | TDaemon>(
  agent: T,
  data: TGetBlocksRequest,
) {
...
export type get_block_count_metrics_command =
  typeof get_block_count_metrics_command;
...
export type WsGetBlockCountMetricsMessage = GetMessageType<
  chia_full_node_service,
  get_block_count_metrics_command,
  TGetBlockCountMetricsResponse
>;
export async function get_block_count_metrics<T extends TRPCAgent | TDaemon>(
  agent: T,
) {
  type R = ResType<
    T,
...
export type get_block_record_by_height_command =
  typeof get_block_record_by_height_command;
...
export type WsGetBlockRecordByHeightMessage = GetMessageType<
  chia_full_node_service,
  get_block_record_by_height_command,
  TGetBlockRecordByHeightResponse
>;
export async function get_block_record_by_height<T extends TRPCAgent | TDaemon>(
  agent: T,
  data: TGetBlockRecordByHeightRequest,
) {
  type R = ResType<
    T,
    TGetBlockRecordByHeightResponse,
...
export type WsGetBlockRecordMessage = GetMessageType<
  chia_full_node_service,
  get_block_record_command,
  TGetBlockRecordResponse
>;
export async function get_block_record<T extends TRPCAgent | TDaemon>(
  agent: T,
  data: TGetBlockRecordRequest,
) {
...
export type WsGetBlockRecordsMessage = GetMessageType<
  chia_full_node_service,
  get_block_records_command,
  TGetBlockRecordsResponse
>;
export async function get_block_records<T extends TRPCAgent | TDaemon>(
  agent: T,
  data: TGetBlockRecordsRequest,
) {
...
export type WsGetBlockSpendsMessage = GetMessageType<
  chia_full_node_service,
  get_block_spends_command,
  TGetBlockSpendsResponse
>;
export async function get_block_spends<T extends TRPCAgent | TDaemon>(
  agent: T,
  data: TGetBlockSpendsRequest,
) {
...
export const get_block_spends_with_conditions_command =
  "get_block_spends_with_conditions";
export type get_block_spends_with_conditions_command =
  typeof get_block_spends_with_conditions_command;
...
export type WsGetBlockSpendsWithConditionsMessage = GetMessageType<
  chia_full_node_service,
  get_block_spends_with_conditions_command,
  TGetBlockSpendsWithConditionsResponse
>;
export async function get_block_spends_with_conditions<
  T extends TRPCAgent | TDaemon,
>(agent: T, data: TGetBlockSpendsWithConditionsRequest) {
  type R = ResType<
    T,
    TGetBlockSpendsWithConditionsResponse,
...
export const get_unfinished_block_headers_command =
  "get_unfinished_block_headers";
export type get_unfinished_block_headers_command =
  typeof get_unfinished_block_headers_command;
export type TGetUnfinishedBlockHeadersResponse = {
  headers: UnfinishedHeaderBlock[];
};
export type WsGetUnfinishedBlockHeadersMessage = GetMessageType<
  chia_full_node_service,
  get_unfinished_block_headers_command,
  TGetUnfinishedBlockHeadersResponse
>;
export async function get_unfinished_block_headers<
  T extends TRPCAgent | TDaemon,
>(agent: T) {
  type R = ResType<
    T,
...
export type WsGetNetworkSpaceMessage = GetMessageType<
  chia_full_node_service,
  get_network_space_command,
  TGetNetworkSpaceResponse
>;
export async function get_network_space<T extends TRPCAgent | TDaemon>(
  agent: T,
  data: TGetNetworkSpaceRequest,
) {
...
export type get_additions_and_removals_command =
  typeof get_additions_and_removals_command;
...
export type WsGetAdditionsAndRemovalsMessage = GetMessageType<
  chia_full_node_service,
  get_additions_and_removals_command,
  TGetAdditionsAndRemovalsResponse
>;
export async function get_additions_and_removals<T extends TRPCAgent | TDaemon>(
  agent: T,
  data: TGetAdditionsAndRemovalsRequest,
) {
  type R = ResType<
    T,
    TGetAdditionsAndRemovalsResponse,
...
export type get_aggsig_additional_data_command =
  typeof get_aggsig_additional_data_command;
export type TGetAggsigAdditionalDataResponse = {
  additional_data: str;
};
export type WsGetAggsigAdditionalDataMessage = GetMessageType<
  chia_full_node_service,
  get_aggsig_additional_data_command,
  TGetAggsigAdditionalDataResponse
>;
export async function get_aggsig_additional_data<T extends TRPCAgent | TDaemon>(
  agent: T,
) {
  type R = ResType<
    T,
...
export const get_initial_freeze_period_command_of_full_node =
  "get_initial_freeze_period";
export type get_initial_freeze_period_command_of_full_node =
  typeof get_initial_freeze_period_command_of_full_node;
export type TGetInitialFreezePeriodResponseOfFullNode = {
  INITIAL_FREEZE_END_TIMESTAMP: uint64;
};
export type WsGetInitialFreezePeriodMessageOfFullNode = GetMessageType<
  chia_full_node_service,
  get_initial_freeze_period_command_of_full_node,
  TGetInitialFreezePeriodResponseOfFullNode
>;
export async function get_initial_freeze_period_of_full_node<
  T extends TRPCAgent | TDaemon,
>(agent: T) {
  type R = ResType<
    T,
...
export const get_recent_signage_point_or_eos_command =
  "get_recent_signage_point_or_eos";
export type get_recent_signage_point_or_eos_command =
  typeof get_recent_signage_point_or_eos_command;
...
export type WsGetRecentSignagePointOrEOSCommandMessage = GetMessageType<
  chia_full_node_service,
  get_recent_signage_point_or_eos_command,
  TGetRecentSignagePointOrEOSCommandResponse
>;
export async function get_recent_signage_point_or_eos<
  T extends TRPCAgent | TDaemon,
>(agent: T, data: TGetRecentSignagePointOrEOSCommandRequest) {
  type R = ResType<
    T,
    TGetRecentSignagePointOrEOSCommandResponse,
...
export const get_coin_records_by_puzzle_hash_command =
  "get_coin_records_by_puzzle_hash";
export type get_coin_records_by_puzzle_hash_command =
  typeof get_coin_records_by_puzzle_hash_command;
...
export type WsGetCoinRecordsByPuzzleHashMessage = GetMessageType<
  chia_full_node_service,
  get_coin_records_by_puzzle_hash_command,
  TGetCoinRecordsByPuzzleHashResponse
>;
export async function get_coin_records_by_puzzle_hash<
  T extends TRPCAgent | TDaemon,
>(agent: T, data: TGetCoinRecordsByPuzzleHashRequest) {
  type R = ResType<
    T,
    TGetCoinRecordsByPuzzleHashResponse,
...
export const get_coin_records_by_puzzle_hashes_command =
  "get_coin_records_by_puzzle_hashes";
export type get_coin_records_by_puzzle_hashes_command =
...
export type WsGetCoinRecordsByPuzzleHashesMessage = GetMessageType<
  chia_full_node_service,
  get_coin_records_by_puzzle_hashes_command,
  TGetCoinRecordsByPuzzleHashesResponse
>;
export async function get_coin_records_by_puzzle_hashes<
  T extends TRPCAgent | TDaemon,
>(agent: T, data: TGetCoinRecordsByPuzzleHashesRequest) {
  type R = ResType<
    T,
    TGetCoinRecordsByPuzzleHashesResponse,
...
export type get_coin_record_by_name_command =
  typeof get_coin_record_by_name_command;
...
export type WsGetCoinRecordByNameMessage = GetMessageType<
  chia_full_node_service,
  get_coin_record_by_name_command,
  TGetCoinRecordByNameResponse
>;
export async function get_coin_record_by_name<T extends TRPCAgent | TDaemon>(
  agent: T,
  data: TGetCoinRecordByNameRequest,
) {
  type R = ResType<
    T,
    TGetCoinRecordByNameResponse,
...
export const get_coin_records_by_parent_ids_command =
  "get_coin_records_by_parent_ids";
export type get_coin_records_by_parent_ids_command =
  typeof get_coin_records_by_parent_ids_command;
...
export type WsGetCoinRecordsByParentIdsMessage = GetMessageType<
  chia_full_node_service,
  get_coin_records_by_parent_ids_command,
  TGetCoinRecordsByParentIdsResponse
>;
export async function get_coin_records_by_parent_ids<
  T extends TRPCAgent | TDaemon,
>(agent: T, data: TGetCoinRecordsByParentIdsRequest) {
  type R = ResType<
    T,
    TGetCoinRecordsByParentIdsResponse,
...
export type get_coin_records_by_hint_command =
  typeof get_coin_records_by_hint_command;
...
export type WsGetCoinRecordsByHintMessage = GetMessageType<
  chia_full_node_service,
  get_coin_records_by_hint_command,
  TGetCoinRecordsByHintResponse
>;
export async function get_coin_records_by_hint<T extends TRPCAgent | TDaemon>(
  agent: T,
  data: TGetCoinRecordsByHintRequest,
) {
  type R = ResType<
    T,
    TGetCoinRecordsByHintResponse,
...
export type WsPushTxMessage = GetMessageType<
  chia_full_node_service,
  push_tx_command,
  TPushTxResponse
>;
...
export type get_all_mempool_tx_ids_command =
  typeof get_all_mempool_tx_ids_command;
export type TGetAllMempoolTxIdsResponse = {
  tx_ids: bytes32[];
};
export type WsGetAllMempoolTxIdsMessage = GetMessageType<
  chia_full_node_service,
  get_all_mempool_tx_ids_command,
  TGetAllMempoolTxIdsResponse
>;
export async function get_all_mempool_tx_ids<T extends TRPCAgent | TDaemon>(
  agent: T,
) {
...
export type get_all_mempool_items_command =
  typeof get_all_mempool_items_command;
export type TGetAllMempoolItemsResponse = {
  mempool_items: Record<string, MempoolItemInJsonDict>;
};
export type WsGetAllMempoolItemsMessage = GetMessageType<
  chia_full_node_service,
  get_all_mempool_items_command,
  TGetAllMempoolItemsResponse
>;
export async function get_all_mempool_items<T extends TRPCAgent | TDaemon>(
  agent: T,
) {
...
export type get_mempool_item_by_tx_id_command =
...
export type WsGetMempoolItemByTxIdMessage = GetMessageType<
  chia_full_node_service,
  get_mempool_item_by_tx_id_command,
  TGetMempoolItemByTxIdResponse
>;
export async function get_mempool_item_by_tx_id<T extends TRPCAgent | TDaemon>(
  agent: T,
  data: TGetMempoolItemByTxIdRequest,
) {
  type R = ResType<
    T,
    TGetMempoolItemByTxIdResponse,
...
export const get_mempool_items_by_coin_name_command =
  "get_mempool_items_by_coin_name";
export type get_mempool_items_by_coin_name_command =
  typeof get_mempool_items_by_coin_name_command;
...
export type WsGetMempoolItemsByCoinNameMessage = GetMessageType<
  chia_full_node_service,
  get_mempool_items_by_coin_name_command,
  TGetMempoolItemsByCoinNameResponse
>;
export async function get_mempool_items_by_coin_name<
  T extends TRPCAgent | TDaemon,
>(agent: T, data: TGetMempoolItemsByCoinNameRequest) {
  type R = ResType<
    T,
    TGetMempoolItemsByCoinNameResponse,
...
export type WsGetFeeEstimateMessage = GetMessageType<
  chia_full_node_service,
  get_fee_estimate_command,
  TGetFeeEstimateResponse
>;
export async function get_fee_estimate<T extends TRPCAgent | TDaemon>(
  agent: T,
  data: TGetFeeEstimateRequest,
) {
...
export type WsGetAllBlocksMessage = GetMessageType<
  chia_full_node_service,
  get_all_blocks_command,
...
export type WsFarmBlockMessage = GetMessageType<
  chia_full_node_service,
  farm_block_command,
  TFarmBlockResponse
>;
export async function farm_block<T extends TRPCAgent | TDaemon>(
  agent: T,
  data: TFarmBlockRequest,
) {
...
export type WsSetAutoFarmingMessage = GetMessageType<
  chia_full_node_service,
  set_auto_farming_command,
  TSetAutoFarmingResponse
>;
export async function set_auto_farming<T extends TRPCAgent | TDaemon>(
  agent: T,
  data: TSetAutoFarmingRequest,
) {
...
export type WsGetAutoFarmingMessage = GetMessageType<
  chia_full_node_service,
  get_auto_farming_command,
  TGetAutoFarmingResponse
>;
export async function get_auto_farming<T extends TRPCAgent | TDaemon>(
  agent: T,
) {
...
export type WsGetFarmingPhMessage = GetMessageType<
  chia_full_node_service,
  get_farming_ph_command,
...
export type WsGetAllCoinsMessage = GetMessageType<
  chia_full_node_service,
  get_all_coins_command,
  TGetAllCoinsResponse
>;
export async function get_all_coins<T extends TRPCAgent | TDaemon>(
  agent: T,
  data: TGetAllCoinsRequest,
) {
...
export type get_all_puzzle_hashes_command =
  typeof get_all_puzzle_hashes_command;
export type TGetAllPuzzleHashesResponse = {
  puzzle_hashes: Record<bytes32, [uint128, int]>;
  success: bool;
};
export type WsGetAllPuzzleHashesMessage = GetMessageType<
  chia_full_node_service,
  get_all_puzzle_hashes_command,
  TGetAllPuzzleHashesResponse
>;
export async function get_all_puzzle_hashes<T extends TRPCAgent | TDaemon>(
  agent: T,
) {
...
export type WsRevertBlocksMessage = GetMessageType<
  chia_full_node_service,
  revert_blocks_command,
  TRevertBlocksResponse
>;
export async function revert_blocks<T extends TRPCAgent | TDaemon>(
  agent: T,
  data: TRevertBlocksRequest,
) {
...
export type WsReorgBlocksMessage = GetMessageType<
  chia_full_node_service,
  reorg_blocks_command,
  TReorgBlocksResponse
>;
export async function reorg_blocks<T extends TRPCAgent | TDaemon>(
  agent: T,
  data: TReorgBlocksRequest,
) {
