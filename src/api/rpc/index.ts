...
export {
  ...
  TGetPuzzleAndSolutionRequest as TGetPuzzleAndSolutionRequestOfWallet,
  TGetPuzzleAndSolutionResponse as TGetPuzzleAndSolutionResponseOfWallet,
  get_puzzle_and_solution as get_puzzle_and_solution_of_wallet,
  ...
  TGatherSigningInfoRequest,
  TGatherSigningInfoResponse,
  gather_signing_info,
  TApplySignaturesRequest,
