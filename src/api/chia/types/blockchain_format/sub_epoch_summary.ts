...
export type SubEpochSummary = {
  ...
  new_difficulty?: uint64; // Optional[uint64]  # Only once per epoch (diff adjustment)
  new_sub_slot_iters?: uint64; // Optional[uint64]  # Only once per epoch (diff adjustment)
};
