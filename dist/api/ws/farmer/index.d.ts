...
export declare type chia_farmer_commands = new_farming_info_command | new_signage_point_command;
export declare type TChiaFarmerBroadcast = TNewFarmingInfoBroadCast | TNewSignagePointBroadCast;
